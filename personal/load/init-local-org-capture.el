...
;; Code
;; org-capture
(custom-set-variables `(org-default-notes-file
...
(custom-set-variables `(org-capture-templates nil))

(defvar kyt/org-capture-templates
  (append '(("d" "Django")
  ...
  "Kyt 'org-capture' templates.")

(custom-set-variables `(org-capture-templates
                        kyt/org-capture-templates))
